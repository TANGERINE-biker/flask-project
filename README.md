...
+ Создает пользователя (проверяет почту на правильность), который может писать посты, ставить реакции (like, dislike, fire, smile_emoji, crying_emoji, what_emoji) на посты других пользователей
